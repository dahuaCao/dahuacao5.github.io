...
!function (root, factory) {
    ...
    var _data = {
        ...
        'm,f,xs':['姑姥姥','姑外祖母','外姑祖母','外太姑母','姑婆'],
        'm,f,xs,h':['姑姥爷','姑外祖父','外姑祖父','外太姑父','姑公'],
        ...
        'm,m,xb,w':['外舅婆','外舅祖母','外太舅母','舅外祖母','舅姥姥','舅婆'],
        ...
        'xs,d':['外甥女','外甥囡'],
        'xs,d,h':['外甥女婿'],
        'xs,d,s':['外甥孙','甥孙男','甥孙','甥外孙男'],
        'xs,d,s,w':['外甥孙媳妇'],
        'xs,d,s,s':['外曾甥孙'],
        'xs,d,s,d':['外曾甥孙女'],
        'xs,d,d':['外甥孙女','甥孙女','甥孙','甥外孙女'],
        'xs,d,d,h':['外甥孙女婿'],
        'xs,d,d,s':['外曾甥孙'],
        'xs,d,d,d':['外曾甥孙女'],
        'os':['姐姐','姐','家姐','阿姐','阿姊'],
